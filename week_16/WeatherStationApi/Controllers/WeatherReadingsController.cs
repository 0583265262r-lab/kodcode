...
namespace WeatherStationApi.Controllers
{
    ...
    {
            // In-memory storage - a static list acts as our "database" for today
        ...
        public ActionResult<WeatherReading> GetReadingById(int id)
        {
          ...
          return Ok(reading);
                ...
                // GET: api/weatherreadings/location/North
    ...
    StringComparison.OrdinalIgnoreCase)).ToList();
        ...
        // GET: api/weatherreadings/search?minTemp=20&maxTemp=25
        [HttpGet("search")]
